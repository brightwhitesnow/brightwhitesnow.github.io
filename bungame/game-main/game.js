        ...
        projectiles.forEach((projectile, projectileIndex) => {
            ...
            if (dist - enemy.radius - projectile.radius < 1) {
                ...
                if (enemy.radius - 10 > 5) {
                    score += 100
                    scoreEl.innerHTML = score
                    gsap.to(enemy, radius = { radius: enemy.radius - 10 })
                    setTimeout(() => {
...
musicCon.addEventListener('click', () => {
    if (uncho == true) {
        music.pause()
        musicCon.style.backgroundImage = "url('https://images.vexels.com/media/users/3/135161/isolated/preview/43a65a8a0f716c2a7d2ed3e60e1aac5a-mute-button-circle-icon-by-vexels.png')"
        uncho = false
    } else {
        music.play()
        musicCon.style.backgroundImage = "url('https://cdn.pixabay.com/photo/2017/07/09/20/48/speaker-2488096_1280.png')"
        uncho = true
    }
})
